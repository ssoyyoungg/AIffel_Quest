__Meta__
# <u>마크 저커버그</u>가 직접 만들어 본 AI 비서 <br/>'자비스'
###### 2016년 12월 19일
...
### GPT-4 발표한 오픈AI '<u>샘 알트만'</u>, "AI가 사회를 재구성할 것이며 위험을 인정합니다, 이것이 조금 두렵습니다"
...
___
### 세계 4대 AI 석학 <u>앤드류 응 교수</u>, "인공지능 업계에 영원한 봄 왔다"
...
___
# 회고
AGI의 등장에 조금은 기대가 된다. 단지 한가지 목적만을 위해서 사용되는 AI가 일상생활족 복합적인 아이디어
