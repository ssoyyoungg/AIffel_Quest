__Meta__
# <ins>마크 저커버그</ins>가 직접 만들어 본 AI 비서 <br/>'자비스'
###### 2016년 12월 19일
...
[![]()](https://video-ams4-1.xx.fbcdn.net/v/t42.1790-2/15638121_660538080785423_7664156663384899584_n.mp4?_nc_cat=111&ccb=1-7&_nc_sid=55d0d3&efg=eyJybHIiOjMwMCwicmxhIjo1MTIsInZlbmNvZGVfdGFnIjoic3ZlX3NkIiwidmlkZW9faWQiOjEwMTAzMzUxMDM0NzQxMzExfQ%3D%3D&_nc_ohc=MfpPKreGwocQ7kNvgHDqnB5&rl=300&vabr=126&_nc_ht=video-ams4-1.xx&edm=ACRN2rcEAAAA&oh=00_AYCQURc3QLyFI6GxD_pieJaSodbsVgwWDtSCHhmKh5wpmA&oe=664876D9)
...
### GPT-4 발표한 오픈AI '<ins>샘 알트만'</ins>, "AI가 사회를 재구성할 것이며 위험을 인정합니다, 이것이 조금 두렵습니다"
...
___
### 세계 4대 AI 석학 <ins>앤드류 응 교수</ins>, "인공지능 업계에 영원한 봄 왔다"
...
___
# 회고
AGI의 등장에 조금은 기대가 된다. 단지 한가지 목적만을 위해서 사용되는 AI가 일상생활족 복합적인 아이디어, 개인 맞춤형 서비스로서 나아가는 단계로서 진입했다고 믿는다.
더 열심히 공부하여 이러한 산업의 선봉장이 되어보고 싶다.
